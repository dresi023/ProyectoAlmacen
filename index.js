...
class Almacen {
     ...
     * @function introducir
     * @param {string} objeto 
     * @return unidades metidas o que esta lleno
     */
     ...
     * @param {array} titulo 
     * @param {number} dinero 
     * @return si lo compraste te devuelve el cambio de la compra y sino lo puedes comprar te duelve un -1
     */
